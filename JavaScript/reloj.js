...
window.addEventListener('load', function(){
    ...
    function mantenerColor(){
        var index =document.getElementById('menuReloj');
    ...
    function mostrarHora(){
        ...
        var etiquetaTiempo = document.createElement('p');
        etiquetaTiempo.prepend(hora);
        contenedor.appendChild(etiquetaTiempo);

        var etiquetaTiempo = document.createElement('p');
        etiquetaTiempo.prepend(minuto);
        contenedor.appendChild(etiquetaTiempo);

        var etiquetaTiempo = document.createElement('p');
        etiquetaTiempo.prepend(segundo);
        contenedor.appendChild(etiquetaTiempo);
